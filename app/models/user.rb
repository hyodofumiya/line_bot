class User < ApplicationRecord
  ...
  validates :employee_number, uniqueness: true, numericality: {only_integer: true}, length: {is: 5, message: "は5ケタの半角数字で入力してください"}, if: Proc.new { |resource| resource.employee_number.present?}
